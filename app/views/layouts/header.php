...
<nav class="<?= isset($_SESSION['usuario']['tipo']) && $_SESSION['usuario']['tipo'] === 'adm' ? 'adm-header' : 'header' ?>" style="position: fixed; top: 0; left: 0; width: 100%; z-index: 1000;">
    ...
    <div class="botoes-links">
        <?php if (!$eh_inicio): ?>
            <a id="btn-inicio" href="/pentatonicaa/public/"><button>Início</button></a>
        <?php endif; ?>
        ...
        <?php else: ?>
            ...
            <?php if ($_SESSION['usuario']['tipo'] === 'adm'): ?>
                ...
                <a id="btn-cadastrar-leilao" href="/pentatonicaa/public/cadastro-leilao"><button>Cadastrar Leilão</button></a>
            <?php endif; ?>
